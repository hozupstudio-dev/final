 ...
 * Each album fills the viewport; scrolling snaps to the next and its
 * title-chorus video (with audio) auto-plays. The bottom-center motion
 * icon is the mute toggle and also visually shows the sound state.
 */
(function () {
  ...
  // apply central media manifest (assets/js/media.js)
  ...
  sound.addEventListener('keydown', (e) => {
    if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); soundOn = !soundOn; applySound(); }
  });
